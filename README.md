...
![Chrome Version](https://img.shields.io/badge/chrome-1.7.0-blue)
![Firefox Version](https://img.shields.io/badge/firefox-1.6.1-orange)
...
- **バージョンアップ**: 内部バージョンおよび UI 表示を更新（Chrome: 1.7.0, Firefox: 1.6.1）。
